...
bag_grid <- bag_grid %>%
  mutate(train = list(train),
         rf_mod = pmap(trees, min_n, ~rand_forest(mode = "regression", mtry = 13, trees = .x, min_n = .y)),
